...
{
    /// <summary>Throws an <see cref="argument"/> if <paramref name="argument"/> is null.</summary>
    /// <param name="paramName">The reference type argument to validate as non-null.</param>
    /// <param name="argument">The name of the parameter with which <paramref name="argument"/> corresponds.</param>
